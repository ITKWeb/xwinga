...
public class Box {
	...
	public enum BoxSet {
		b1("Boite de base", "sw01"), b2("X-wing", "sw02"), b3("Chasseur TIE",
				"sw03"), b4("Y-wing", "sw04"), b5("TIE advanced", "sw05"), b6(
				"Faucon Millenium", "sw06"), b7("Slave 1", "sw07"), b8(
				"A-wing", "sw08"), b9("Intercepteur TIE", "sw09");
